...
Biologisk mangfold, Arter, Norge, Svalbard, Jan Mayen, Artsfordeling, Inspire, geodataloven, Det offentlige kartgrunnlaget, Norge digitalt, ØkologiskGrunnkart, modellbaserteVegprosjekter, fellesDatakatalog, Natur
...
- **tidsmessig**: - **intervall**: - 2015-02-16, 2021-01-01
...
- **navn**: COMMISSION REGULATION (EU) No 1089/2010 of 23 November 2010 implementing Directive 2007/2/EC of the European Parliament and of the Council as regards interoperability of spatial data sets and services
  **Måleparameter**: Dataene er ikke iht produktspesifikasjonen

- **navn**: SOSI-produktspesifikasjon: Arter av nasjonal forvaltningsinteresse
...
- **format**: - **format**: GEONORGE:DOWNLOAD
  **tilgang**:
  ...
  - **lenke**: <https://geoapi.p.aks.miljodirektoratet.no/geonorge/capabilities/>
...
- **tittel**: Arter av nasjonal forvaltningsinteresse 3 WMS
  **format**: - **format**: PNG
  **tilgang**:

  - **lenke**: <https://arcgis002.miljodirektoratet.no/arcgis/services/artnasjonal3/MapServer/WMSServer>
...
**Metadatalenke**:
<https://www.geonorge.no/geonetwork/srv/nor/csw?service=CSW&request=GetRecordById&version=2.0.2&outputSchema=http://www.isotc211.org/2005/gmd&elementSetName=full&id=a8456aed-441a-40c4-831f-46bcbe4e6ff1>
